...
function e1(r, t) {
  ...
  n && ((e.firefox = !0), (e.version = n[1])),
    ...
    a && ((e.edge = !0), (e.version = a[1]), (e.newEdge = +a[1].split(".")[0] > 18)),
    o && (e.weChat = !0),
...
function z(r, t, e) {
  ...
  for (var n = [], i = 0, a = r.length; i < a; i++) n.push(t.call(e, r[i], i, r));
  return n;
}
function oi(r, t, e, n) {
  if (!!(r && t)) {
        ...
        if (e) {
          ...
          (this._dropTarget = s),
            e !== s &&
              (u &&
                s !== u &&
                this.handler.dispatchToElement(new mn(u, t), "dragleave", t.event),
              s &&
                s !== u &&
                this.handler.dispatchToElement(new mn(s, t), "dragenter", t.event));
        }
      }),
...
var D1 = (function () {
  ...
  return (
    (r.prototype.on = function (t, e, n, i) {
      ...
      var u = { h: n, query: e, ctx: i || this, callAtLast: n.zrEventfulCallAtLast },
        l = a[t].length - 1,
        f = a[t][l];
...
function Tl(r, t, e, n, i, a) {
  ...
  for (var h = 0, c = 0, v = 0; c < s; c++) {
    var d = 1 << c;
    d & i || ((h += (v % 2 ? -1 : 1) * r[e][c] * Tl(r, t - 1, f, l, i | d, a)), v++);
  }
  return (a[o] = h), h;
}
function nv(r, t) {
  ...
  if (i !== 0) {
    for (var a = [], o = 0; o < 8; o++)
      for (var s = 0; s < 8; s++)
        a[s] == null && (a[s] = 0),
          (a[s] +=
            ((((o + s) % 2 ? -1 : 1) * Tl(e, 7, o === 0 ? 1 : 0, 1 << o, 1 << s, n)) /
              i) *
            t[o]);
...
var B1 = (function () {
  ...
  return (
    ...
    (r.prototype._doTrack = function (t, e, n) {
      ...
      if (!!i) {
        for (
          var a = { points: [], touches: [], target: e, event: t }, o = 0, s = i.length;
          o < s;
          o++
        ) {
          var u = i[o],
  ...
  Tg = (function (r) {
    ...
    return (
      ...
      (t.prototype.mouseout = function (e) {
        ...
        n !== "only_globalout" && this.dispatchToElement(this._hovered, "mouseout", e),
          n !== "no_globalout" &&
      ...
      (t.prototype.findHover = function (e, n, i) {
        for (
          var a = this.storage.getDisplayList(), o = new hi(e, n), s = a.length - 1;
          s >= 0;
          s--
        ) {
          var u = void 0;
  ...
  function (r) {
    Tg.prototype[r] = function (t) {
      var e = t.zrX,
        ...
        o;
      if (
        ((r !== "mouseup" || !i) && ((a = this.findHover(e, n)), (o = a.target)),
        r === "mousedown")
      )
      ...
      if (!(t.ignore && !n)) {
        ...
        if (t.childrenRef) {
          for (var s = t.childrenRef(), u = 0; u < s.length; u++) {
            var l = s[u];
            t.__dirty && (l.__dirty |= Qt), this._updateAndAddDisplayable(l, e, n);
          }
          t.__dirty = 0;
        } else {
          var f = t;
...
var To = {
    ...
    return r === 0
      ...
      : r === 1
        ...
        : (!e || e < 1
          ...
          -(e * Math.pow(2, 10 * (r -= 1)) * Math.sin(((r - t) * (2 * Math.PI)) / n)));
  },
  ...
  bounceInOut: function (r) {
    return r < 0.5 ? To.bounceIn(r * 2) * 0.5 : To.bounceOut(r * 2 - 1) * 0.5 + 0.5;
  },
};
const Ag = To;
var Ba = Math.pow,
...
function kg(r) {
  ...
  if (t) {
    ...
    var s = [];
    return function (u) {
      return u <= 0 ? 0 : u >= 1 ? 1 : Vo(0, n, a, 1, u, s) && Tt(0, i, o, 1, s[0]);
    };
  }
}
var j1 = (function () {
  ...
  rS = (function () {
    ...
    return (
      ...
      (r.prototype.get = function (t) {
        var e = this._map[t],
          n = this._list;
        if (e != null) return e !== n.tail && (n.remove(e), n.insertEntry(e)), e.value;
      }),
      (r.prototype.clear = function () {
...
function yv(r, t) {
  ...
  if (e) {
    for (var n = 0; n < 3; n++)
      t < 0 ? (e[n] = (e[n] * (1 - t)) | 0) : (e[n] = ((255 - e[n]) * t + e[n]) | 0),
...
function Yo(r, t) {
  var e = $e(r);
  return e
    ? ((0.299 * e[0] + 0.587 * e[1] + 0.114 * e[2]) * e[3]) / 255 + (1 - e[3]) * t
    : 0;
}
function iS(r) {
  ...
  fS = (function () {
    ...
    return (
      ...
      (r.prototype.addKeyframe = function (t, e, n) {
        ...
        if (Ht(e)) {
          var l = lS(e);
          (s = l), ((l === 1 && !ft(e[0])) || (l === 2 && !ft(e[0][0]))) && (o = !0);
        ...
        a === 0 ? (this.valType = s) : (s !== this.valType || s === _v) && (o = !0),
      ...
      (r.prototype.prepare = function (t, e) {
        ...
        for (
          ...
          var h = n[f],
            ...
            v = o.value;
          (h.percent = h.time / t),
            s || (u && f !== a - 1 ? uS(c, v, i) : l && sS(c.colorStops, v.colorStops));
        }
        if (
          !s &&
          i !== El &&
          ...
          for (var d = n[0].value, f = 0; f < a; f++)
            i === Ha
              ...
              : i === Ni
                ...
                : Va(i) &&
                  (n[f].additiveValue =
                    i === Do ? Ga([], n[f].value, d, -1) : mv([], n[f].value, d, -1));
        }
      }),
      (r.prototype.step = function (t, e) {
        if (!this._finished) {
          ...
          if (!!(v && d)) {
            ...
            if (((Va(a) || l) && !m && (m = this._additiveValue = []), this.discrete))
              t[u] = y < 1 ? v.rawValue : d.rawValue;
            else if (Va(a)) a === Do ? nu(m, v[i], d[i], y) : oS(m, v[i], d[i], y);
            else if (Sv(a)) {
              var _ = v[i],
                S = d[i],
                w = a === Rl;
              (t[u] = {
                ...
                w
                  ? ((t[u].x2 = We(_.x2, S.x2, y)), (t[u].y2 = We(_.y2, S.y2, y)))
                  : (t[u].r = We(_.r, S.r, y));
  ...
  hS = (function () {
    ...
    return (
      ...
      (r.prototype.during = function (t) {
        return (
          t && (this._onframeCbs || (this._onframeCbs = []), this._onframeCbs.push(t)),
          this
        );
      }),
      (r.prototype.done = function (t) {
        return (
          t && (this._doneCbs || (this._doneCbs = []), this._doneCbs.push(t)), this
        );
      }),
      (r.prototype.aborted = function (t) {
        return (
          t && (this._abortedCbs || (this._abortedCbs = []), this._abortedCbs.push(t)),
          this
        );
      }),
...
var vS = (function (r) {
  ...
  return (
    ...
    (t.prototype.update = function (e) {
      for (var n = Gn() - this._pausedTime, i = n - this._time, a = this._head; a; ) {
        var o = a.next,
          s = a.step(n, i);
        s && (a.ondestroy(), this.removeClip(a)), (a = o);
      }
      (this._time = n),
        e || (this.trigger("frame", i), this.stage.update && this.stage.update());
    }),
    ...
    (t.prototype.start = function () {
      this._running || ((this._time = Gn()), (this._pausedTime = 0), this._startLoop());
    }),
...
var dS = 300,
  ...
  xv = { mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"] },
  wv = !1;
function Ol(r) {
  var t = r.pointerType;
...
function zg(r, t) {
  for (
    var e = t, n = !1;
    e && e.nodeType !== 9 && !(n = e.domBelongToZr || (e !== t && e === r.painterRoot));
...
var yS = (function () {
  ...
  me = {
    ...
    mousemove: function (r) {
      ...
      t && (r.zrX !== t[0] || r.zrY !== t[1]) && this.__togglePointerCapture(!0),
...
function _S(r, t) {
  ...
  function e(n) {
    function i(a) {
      (a = Vf(a)), zg(r, a.target) || ((a = gS(r, a)), t.domHandlers[n].call(r, a));
    }
    Ao(t, n, i, { capture: !0 });
  }
}
...
function su(r) {
  var t = r.mounted;
  for (var e in t) t.hasOwnProperty(e) && k1(r.domTarget, e, t[e], r.listenerOpts[e]);
  r.mounted = {};
}
var bv = (function () {
    function r(t, e) {
  ...
  SS = (function (r) {
    ...
    return (
      ...
      (t.prototype.__togglePointerCapture = function (e) {
        if (((this.__mayPointerCapture = null), iu && +this.__pointerCapturing ^ +e)) {
  ...
  CS = (function () {
    ...
    return (
      ...
      (r.prototype._resolveGlobalScaleRatio = function (t) {
        ...
        (this.invTransform = this.invTransform || ia()), ms(this.invTransform, t);
      }),
    ...
    return (
      ...
      (r.prototype.calculateTransform = function (t) {
        var e = this,
          ...
          i = t.height / e.height,
          a = ia();
        return zl(a, a, [-e.x, -e.y]), TS(a, a, [n, i]), zl(a, a, [t.x, t.y]), a;
      }),
      ...
      (r.prototype.updateInnerText = function (t) {
        ...
        if (e && (!e.ignore || t)) {
          ...
          if ((a.copyTransform(e), n.position != null)) {
            var f = IS;
            n.layoutRect ? f.copy(n.layoutRect) : f.copy(this.getBoundingRect()),
          ...
          var g =
              n.inside == null
                ? typeof n.position == "string" && n.position.indexOf("inside") >= 0
                : n.inside,
        ...
        for (var u = {}, l = !1, f = 0; f < hu.length; f++) {
          ...
          e && e[h] != null
            ? c
              ? ((l = !0), (u[h] = e[h]))
              : (this[h] = e[h])
            : s && n[h] != null && (c ? ((l = !0), (u[h] = n[h])) : (this[h] = n[h]));
        }
        if (!a)
...
function RS(r, t, e) {
  if (Ht(t[e]))
    if ((Ht(r[e]) || (r[e] = []), jt(t[e]))) {
      var n = t[e].length;
      r[e].length !== n && ((r[e] = new t[e].constructor(n)), cu(r[e], t[e], n));
    } else {
      var i = t[e],
        a = r[e],
        o = i.length;
...
var Ug = (function (r) {
  ...
  return (
    ...
    (t.prototype.getBoundingRect = function (e) {
      for (
        var n = new at(0, 0, 0, 0), i = e || this._children, a = [], o = null, s = 0;
        s < i.length;
        s++
      ) {
        var u = i[s];
...
var NS = (function () {
  function r(t, e, n) {
    ...
    var l = !j.node && !j.worker && !u ? new xS(s.getViewportRoot(), s.root) : null;
...
function tx(r, t, e) {
  C(r, function (n) {
    var i = n.newOption;
    H(i) && ((n.keyInfo.mainType = t), (n.keyInfo.subType = ex(t, i, n.existing, e)));
  });
}
function ex(r, t, e, n) {
  ...
  return (
    C(e, function (s, u) {
      ...
      var l = u.match(/^(\w+)(Index|Id|Name)$/) || [],
        f = l[1],
        h = (l[2] || "").toLowerCase();
      if (!(!f || !h || (t && t.includeMainTypes && J(t.includeMainTypes, f) < 0))) {
        o = o || !!f;
...
function Da(r, t, e, n) {
  ...
  return i === "none" || i === !1
    ? (ke(n.enableNone, '`"none"` or `false` is not a valid value on index option.'),
      (s.models = []),
      s)
    : (i === "all" &&
...
function sx(r) {
  ke(/^[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)?$/.test(r), 'componentType "' + r + '" illegal');
}
function ux(r) {
  return !!(r && r[ny]);
}
  ...
  Lx = (function (r) {
    ...
    return (
      ...
      (t.prototype.dirtyStyle = function (e) {
        e || this.markRedraw(), (this.__dirty |= Bi), this._rect && (this._rect = null);
      }),
        ...
        if (
          (n && n.style
            ? o
              ...
              : ((l = this._mergeStyle(this.createStyle(), a ? this.style : i.style)),
                this._mergeStyle(l, n.style))
            : u && (l = i.style),
          l)
        )
          if (o) {
            ...
            this._transitionState(e, { style: l }, s, this.getAnimationStyleProps());
...
function Ex(r, t, e, n, i, a, o, s, u) {
  ...
  for (var v = 0; v < a; v += Math.PI / 2)
    v > i &&
      ((Za[0] = _u(v) * e + r), (Za[1] = mu(v) * n + t), l(s, Za, s), f(u, Za, u));
}
...
var kx = (function () {
  ...
  return (
    ...
    (r.prototype.setScale = function (t, e, n) {
      (n = n || 0),
        n > 0 && ((this._ux = Ge(n / $o / t) || 0), (this._uy = Ge(n / $o / e) || 0));
    }),
    ...
    (r.prototype.setData = function (t) {
      var e = t.length;
      !(this.data && this.data.length === e) && wu && (this.data = new Float32Array(e));
      for (var n = 0; n < e; n++) this.data[n] = t[n];
      this._len = e;
    }),
    (r.prototype.appendPath = function (t) {
      t instanceof Array || (t = [t]);
      for (var e = t.length, n = 0, i = this._len, a = 0; a < e; a++) n += t[a].len();
      wu && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
      for (var a = 0; a < e; a++)
      ...
      case rr.C:
        if (e) {
          if (Bx(u, l, a[d++], a[d++], a[d++], a[d++], a[d], a[d + 1], t, n, i))
            return !0;
        } else s += Vx(u, l, a[d++], a[d++], a[d++], a[d++], a[d], a[d + 1], n, i) || 0;
        (u = a[d++]), (l = a[d++]);
        break;
      case rr.Q:
        if (e) {
    ...
    return (
      ...
      (t.prototype.getBoundingRect = function () {
        ...
        if (i) {
          ...
          var o = this.path;
          (a || this.__dirty & kn) &&
            (o.beginPath(), this.buildPath(o, this.shape, !1), this.pathUpdated()),
            (e = o.getBoundingRect());
        }
...
var cy = (function (r) {
  ...
  return (
    ...
    (t.prototype.getBoundingRect = function () {
      ...
      return (
        this._rect ||
          (this._rect = new at(e.x || 0, e.y || 0, this.getWidth(), this.getHeight())),
        this._rect
      );
    }),
    t
...
var Hv = { fill: "#000" },
  ...
  yy = (function (r) {
    ...
    function t(e) {
      var n = r.call(this) || this;
      return (
        (n.type = "text"), (n._children = []), (n._defaultStyle = Hv), n.attr(e), n
      );
    }
    return (
      (t.prototype.childrenRef = function () {
      ...
      (t.prototype.getBoundingRect = function () {
        if ((this.styleChanged() && this._updateSubTexts(), !this._rect)) {
          for (
            var e = new at(0, 0, 0, 0), n = this._children, i = [], a = null, o = 0;
            o < n.length;
            o++
          ) {
            var s = n[o],
            ...
            l
              ? (e.copy(u), e.applyTransform(l), (a = a || e.clone()), a.union(e))
      ...
      (t.prototype._mergeStyle = function (e, n) {
        ...
        var i = n.rich,
          a = e.rich || (i && {});
        return (
          k(e, n), i && a ? (this._mergeRich(a, i), (e.rich = a)) : a && (e.rich = a), e
        );
      }),
      ...
      (t.prototype._updatePlainTexts = function () {
        ...
        for (
          ...
          E.useStyle(R),
            ...
            L &&
              E.setBoundingRect(
                new at(Fi(R.x, e.width, R.textAlign), Bn(R.y, I, R.textBaseline), h, I),
              );
        }
      }),
      ...
      (t.prototype._placeToken = function (e, n, i, a, o, s, u) {
        ...
        var v = !!l.backgroundColor,
          d = e.textPadding;
        d && ((o = Xv(o, s, d)), (h -= e.height / 2 - d[0] - e.innerHeight / 2));
        ...
        var y = this._defaultStyle,
          m = !1,
          _ = 0,
          S = Zv("fill" in l ? l.fill : "fill" in n ? n.fill : ((m = !0), y.fill)),
          w = $v(
            "stroke" in l
              ? l.stroke
              : "stroke" in n
        ...
        (p.text = e.text),
          ...
          x &&
            ...
            (p.shadowColor = l.textShadowColor || n.textShadowColor || "transparent"),
            (p.shadowOffsetX = l.textShadowOffsetX || n.textShadowOffsetX || 0),
            (p.shadowOffsetY = l.textShadowOffsetY || n.textShadowOffsetY || 0)),
          (p.textAlign = s),
      ...
      (t.prototype._renderBackground = function (e, n, i, a, o, s) {
        ...
        if (l && f) {
          ...
          (m.lineWidth = l),
            ...
            g.hasFill() && g.hasStroke() && ((m.strokeFirst = !0), (m.lineWidth *= 2));
        }
        var S = (g || p).style;
...
function aw(r) {
  return typeof r == "string" &&
    (r.indexOf("px") !== -1 || r.indexOf("rem") !== -1 || r.indexOf("em") !== -1)
    ? r
    : isNaN(+r)
      ? Nf + "px"
      : r + "px";
...
function gw(r, t, e) {
  ...
  return (
    o.opacity == null &&
      ((e = k({}, e)), (o = k({ opacity: n ? i : a.opacity * 0.1 }, o)), (e.style = o)),
    e
  );
}
function Mu(r, t) {
    ...
    i.eachSeries(function (l) {
      ...
      if (
        ...
        if (
          ...
          for (var d = pt(t), g = 0; g < d.length; g++) a(l.getData(d[g]), t[d[g]]);
...
function ww(r, t, e) {
  if (!!Xl(t)) {
    var n = t.dataType,
      ...
      a = ln(i, t);
    N(a) || (a = [a]),
      r[t.type === Xi ? "toggleSelect" : t.type === Zi ? "select" : "unselect"](a, n);
  }
}
function ic(r) {
  var t = r.getAllData();
...
function Dy(r, t) {
  var e = t === !1,
    n = r;
  r.highDownSilentOnTouch && (n.__highDownSilentOnTouch = r.highDownSilentOnTouch),
...
function Ay(r, t) {
  if (!!t) {
    ...
    for (o = 0, s = 0; o < n; ) {
      ...
      for (u = 0; u < a; u++) {
        var w = Lw[u];
        (w[0] = e[o++]), (w[1] = e[o++]), fe(w, w, t), (e[s++] = w[0]), (e[s++] = w[1]);
      }
    }
    r.increaseVersion();
  }
    ...
    if (!(isNaN(u) || isNaN(l))) {
      ...
      if ((d > ye && (v = d), !(n > ye))) r.moveTo(f, h);
        ...
        r.moveTo(f + n * Cn(u), h + n * zr(u)),
          r.arc(f, h, n, u, l, !c),
          i > ye && (r.moveTo(f + i * Cn(l), h + i * zr(l)), r.arc(f, h, i, l, u, c));
      else {
        var g = void 0,
          p = void 0,
          y = void 0,
        ...
        if (B) {
          ...
          if (
            ...
            if (lt) {
              ...
              (M = Ae(b, (n - ze) / (pe + 1))), (D = Ae(T, (i - ze) / (pe - 1)));
            }
          }
        }
        if (!B) r.moveTo(f + E, h + R);
          ...
          r.moveTo(f + X.cx + X.x0, h + X.cy + X.y0),
            M < b && It === St
              ? r.arc(f + X.cx, h + X.cy, M, Pt(X.y0, X.x0), Pt(tt.y0, tt.x0), !c)
              : (It > 0 &&
                  r.arc(f + X.cx, h + X.cy, It, Pt(X.y0, X.x0), Pt(X.y1, X.x1), !c),
                r.arc(
                  f,
                  h,
                  n,
        ...
        if (!(i > ye) || !B) r.lineTo(f + V, h + F);
          ...
          r.lineTo(f + X.cx + X.x0, h + X.cy + X.y0),
            D < T && It === St
              ? r.arc(f + X.cx, h + X.cy, D, Pt(X.y0, X.x0), Pt(tt.y0, tt.x0), !c)
              : (St > 0 &&
                  r.arc(f + X.cx, h + X.cy, St, Pt(X.y0, X.x0), Pt(X.y1, X.x1), !c),
                r.arc(
                  f,
                  h,
                  i,
...
function Yw(r, t, e, n) {
  ...
  for (var c = 0, v = r.length; c < v; c++) {
    ...
    var m = rv([], d, o),
      _ = rv([], d, s);
    n && (zn(m, m, f), Fn(m, m, h), zn(_, _, f), Fn(_, _, h)), i.push(m), i.push(_);
  }
...
function cc(r, t, e) {
  ...
  return n != null || i != null
    ...
    : [(e ? dv : Ot)(r.x1, r.cpx1, r.x2, t), (e ? dv : Ot)(r.y1, r.cpy1, r.y2, t)];
}
var Wy = (function (r) {
  O(t, r);
  function t(e) {
...
var Jw = (function (r) {
  ...
  return (
    ...
    (t.prototype.afterBrush = function () {
      for (var e = this.shape.paths || [], n = 0; n < e.length; n++) e[n].pathUpdated();
    }),
    (t.prototype.getBoundingRect = function () {
    ...
    return (
      ...
      (r.prototype.intersect = function (t, e) {
        ...
        return (
          Qa.set(1 / 0, 1 / 0),
          Ja.set(0, 0),
          (!this._intersectCheckOneSide(this, t, Qa, Ja, i, 1) && ((n = !1), i)) ||
            (!this._intersectCheckOneSide(t, this, Qa, Ja, i, -1) && ((n = !1), i)) ||
            i ||
            Z.copy(e, n ? Qa : Ja),
          n
        );
...
function Ms(r, t, e, n, i) {
  ...
  if (s) {
    ...
    n
      ...
      : ((l = t.getShallow(u ? "animationDurationUpdate" : "animationDuration")),
...
var mb = jr;
function Ds(r, t) {
  for (var e = Uf([]); r && r !== t; ) Zn(e, r.getLocalTransform(), e), (r = r.parent);
  return e;
}
function la(r, t, e) {
  return (
    t && !Ht(t) && (t = Ca.getLocalTransform(t)), e && (t = ms([], t)), fe([], r, t)
  );
}
function sh(r, t, e) {
...
function Ls(r) {
  ...
  (l.componentMainType = a),
    (l.componentIndex = o),
    (l.tooltipConfig = { name: n, option: q({ content: n, formatterParams: s }, i) });
}
function gc(r, t) {
  var e;
...
function Ql(r, t, e) {
  ...
  n &&
    ...
    s == null && (s = U(r.defaultText) ? r.defaultText(i, r, e) : r.defaultText);
...
function yc(r, t, e) {
  ...
  return (
    ...
    o != null && (n.distance = o),
    (n.outsideFill = r.get("color") === "inherit" ? t.inheritColor || null : "auto"),
    n
  );
}
...
function Db(r, t, e, n, i) {
  ...
  (r.percent = 0), (a.prevValue == null ? Ke : we)(r, { percent: 1 }, n, t, null, l);
}
    ...
    return (
      ...
      (r.prototype.getModel = function (t, e) {
        ...
        return (
          (e =
            e ||
            (this.parentModel && this.parentModel.getModel(this.resolveParentPath(i)))),
      ...
      (r.prototype._doGet = function (t, e) {
        ...
        for (
          var i = 0;
          i < t.length &&
          !(!!t[i] && ((n = n && typeof n == "object" ? n[t[i]] : null), n == null));
          i++
        );
        return (
          n == null && e && (n = e._doGet(this.resolveParentPath(t), e.parentModel)), n
        );
      }),
      r
    );
...
function Yb(r, t, e, n, i) {
  ...
  if (G(e)) a = e;
    ...
    var o = k({}, Hi);
    if (r.level > 0)
      for (var s = 0; s < Ru.length; ++s) o[Ru[s]] = "{primary|" + o[Ru[s]] + "}";
    ...
    return (
      ...
      (t.prototype.mergeDefaultAndTheme = function (e, n) {
        var i = va(this),
          a = i ? Pa(e) : {},
          o = n.getTheme();
        Q(e, o.get(this.mainType)), Q(e, this.getDefaultOption()), i && ei(e, a, i);
      }),
      ...
      (t.prototype.getReferringComponents = function (e, n) {
        var i = e + "Index",
          a = e + "Id";
        return Da(this.ecModel, e, { index: this.get(i, !0), id: this.get(a, !0) }, n);
      }),
  ...
  aria: {
    decal: {
      decals: [
        ...
        { color: Mn, dashArrayX: [1, 0], dashArrayY: [4, 3], rotation: -Math.PI / 4 },
        {
          color: Mn,
          dashArrayX: [
            [6, 6],
...
var mm = W(["tooltip", "label", "itemName", "itemId", "itemGroupId", "seriesName"]),
  de = "original",
  Vt = "arrayRows",
  Te = "objectRows",
  je = "keyedColumns",
...
function iT(r) {
  return !r.get("transform", !0) && !r.get("fromTransformResult", !0)
    ...
    : Da(
        r.ecModel,
        "dataset",
        { index: r.get("fromDatasetIndex", !0), id: r.get("fromDatasetId", !0) },
        zt,
      ).models;
}
function wm(r, t) {
    ...
    return (
      ...
      (t.prototype.eachComponent = function (e, n, i) {
        ...
        if (U(e)) {
          ...
          for (
            var u = G(e) ? a.get(e) : H(e) ? this.findComponents(e) : null, l = 0;
            u && l < u.length;
            l++
          ) {
            var f = u[l];
  ...
  mT = (function () {
    ...
    return (
      ...
      (r.prototype.getMediaOption = function (t) {
        ...
        for (var u = 0, l = i.length; u < l; u++) ST(i[u].query, e, n) && o.push(u);
        return (
          !o.length && a && (o = [-1]),
          o.length &&
...
function _T(r, t, e) {
  ...
  return { baseOption: a, timelineOptions: u || [], mediaDefault: i, mediaList: n };
}
function ST(r, t, e) {
...
function CT(r, t) {
  ...
  t && e.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
    ...
    ge(He(r.calendar), function (n) {
      kt(n, "itemStyle"), mt(n, "dayLabel"), mt(n, "monthLabel"), mt(n, "yearLabel");
    }),
...
function Mm(r, t) {
  if (r) for (var e = 0; e < r.length; e++) t(r[e]), r[e] && Mm(r[e].children, t);
}
function Dm(r, t) {
  CT(r, t),
...
function OT(r, t, e, n, i) {
  var a, o;
  if (!r) return { dimensionsDefine: Fc(i), startIndex: o, dimensionsDetectedCount: a };
  if (t === Vt) {
    var s = r;
    n === "auto" || n == null
      ? zc(
...
function zc(r, t, e, n) {
  if (t === fi) for (var i = 0; i < e.length && i < n; i++) r(e[i] ? e[i][0] : null, i);
      ...
      (r.internalField = (function () {
        ...
        Hc = function (o, s, u) {
          var l = u.sourceFormat,
            ...
            v = Gc[wh(l, f)];
          if ((k(o, v), l === mr)) (o.getItem = e), (o.count = i), (o.fillStorage = n);
          else {
            var d = Pm(l, f);
...
function JT(r) {
  ...
  n.length !== 2 && et(e);
  var i = !1;
  n[0] === "echarts" && ((t = n[1]), (i = !0)), (r.__isBuiltIn = i), Nm.set(t, r);
}
function jT(r, t, e) {
  var n = _t(r),
    i = n.length,
...
function tC(r, t, e, n) {
  ...
  var s = z(t, function (l) {
    ...
    u = _t(o.transform({ upstream: s[0], upstreamList: s, config: K(r.config) }));
...
var iC = (function () {
  ...
  return (
    ...
    (r.prototype.appendData = function (t) {
      ...
      var i = e.count();
      return (
        e.persistent || (i += n), n < i && this._initDataFromProvider(n, i, !0), [n, i]
      );
    }),
    ...
    (r.prototype.getRawDataItem = function (t) {
      ...
      for (var n = [], i = this._chunks, a = 0; a < i.length; a++) n.push(i[a][e]);
      return n;
    }),
    (r.prototype.clone = function (t, e) {
      ...
      if (a) for (var o = 0; o < i.length; o++) n._chunks[o] = a[o] ? nC(i[o]) : i[o];
      else n._chunks = i;
      return (
  ...
  return (
    ...
    (r.prototype._createSource = function () {
      ...
      if (ro(t)) {
        ...
        i = p ? [tf(s, { seriesLayoutBy: v, sourceHeader: d, dimensions: g }, u)] : [];
      } else {
        var y = t;
        if (n) {
...
function sC(r, t, e, n) {
  ...
  C(s, function (d, g) {
    var p = t.valueFormatter,
      y = Wm(d)(p ? k(k({}, r), { valueFormatter: p }) : r, d, g > 0 ? a.html : 0, n);
    y != null && o.push(y);
  });
  var h =
    r.renderMode === "richText" ? o.join(a.richText) : nf(o.join(""), i ? e : a.html);
  if (i) return h;
...
function uC(r, t, e, n) {
  ...
  if (!(a && o)) {
    ...
    return i === "richText"
      ...
      : nf((s ? "" : h) + (a ? "" : fC(c, !s, m)) + (o ? "" : hC(d, g, p, _)), e);
  }
}
  ...
  Gs = (function (r) {
    ...
    return (
      ...
      (t.prototype.isSelected = function (e, n) {
        ...
        return (
          (i === "all" || i[no(a, e)]) && !a.getItemModel(e).get(["select", "disabled"])
        );
      }),
        ...
        if (!(!s || !u)) {
          if (s === "series") o.selectedMap = "all";
            ...
            (o.selectedMap = ((i = {}), (i[c] = !0), i)),
              (this._selectedDataIndicesMap = ((a = {}), (a[c] = e.getRawIndex(v)), a));
          }
        }
      }),
...
function Hs(r, t, e, n) {
  ...
  if (!!i) {
    ...
    if (s !== e || o !== n) {
      ...
      (i = r[t] = qm(a, e, n === "debounce")), (i[es] = a), (i[rd] = n), (i[ed] = e);
    }
    return i;
  }
}
...
function LC(r, t) {
  ...
  return (
    t.showSpinner &&
      ((o = new ih({
        shape: { startAngle: -io / 2, endAngle: -io / 2 + 0.1, r: t.spinnerRadius },
...
var IC = (function () {
  ...
  return (
          ...
          if (c) {
            ...
            h &&
              h.each(function (p, y) {
                ...
                (m.skip = !u.performRawSeries && e.isSeriesFiltered(p.context.model)),
                  o.updatePayload(p, n),
                  p.perform(m) && (a = !0);
              });
        }
    ...
    (r.prototype._createSeriesStageTask = function (t, e, n, i) {
      ...
      function f(h) {
        var c = h.uid,
          v = s.set(c, (o && o.get(c)) || Qi({ plan: kC, reset: BC, count: FC }));
        (v.context = {
          model: h,
          ecModel: n,
          api: i,
    ...
    (r.prototype._createOverallStageTask = function (t, e, n, i) {
      ...
      function d(g) {
        var p = g.uid,
          y = u.set(p, (s && s.get(p)) || ((c = !0), Qi({ reset: RC, onDirty: OC })));
    ...
    return (
      ...
      (r.prototype.filter = function (t, e) {
        ...
        return (
          ...
          f(l, a, "dataIndex") &&
          f(l, a, "dataType") &&
          (!s.filterForExposedEvent || s.filterForExposedEvent(t, e.otherQuery, i, a))
        );
        function f(h, c, v, d) {
...
function ZC(r, t, e) {
  r.on("selectchanged", function (n) {
    var i = e.getModel();
    n.isFromClick
      ? (An("map", "selectchanged", t, i, n), An("pie", "selectchanged", t, i, n))
      : n.fromAction === "select"
  ...
  return (
    r.indexOf("image://") === 0
      ...
      : r.indexOf("path://") === 0
        ...
        : (u = new iM({ shape: { symbolType: r, x: t, y: e, width: n, height: i } })),
    (u.__isEmptyBrush = s),
    (u.setColor = aM),
    a && u.setColor(a),
    u
...
function n0(r, t) {
  if (r != null)
    return N(r) || (r = [r, r]), [Ct(r[0], t[0]) || 0, Ct(nt(r[1], r[0]), t[1]) || 0];
}
function sM(r, t, e) {
...
function sf(r, t, e) {
  for (
    var n = t.type === "radial" ? uM(r, t, e) : sM(r, t, e), i = t.colorStops, a = 0;
    a < i.length;
    a++
  )
...
function so(r, t, e) {
  ...
  return ((r[i] || oo(s[n]) || oo(r.style[n])) - (oo(s[a]) || 0) - (oo(s[o]) || 0)) | 0;
}
function fM(r, t) {
...
function vM(r, t, e, n) {
  ...
  if (!n) {
    ...
    (d || g) && (x = t.getBoundingRect()),
      d &&
        ((m = h ? sf(r, c, x) : t.__canvasFillGradient), (t.__canvasFillGradient = m)),
      g &&
        ((_ = h ? sf(r, v, x) : t.__canvasStrokeGradient),
        (t.__canvasStrokeGradient = _)),
      p &&
        ((S = h || !t.__canvasFillPattern ? uf(r, c, t) : t.__canvasFillPattern),
        (t.__canvasFillPattern = S)),
      y &&
        ((w = h || !t.__canvasStrokePattern ? uf(r, v, t) : t.__canvasStrokePattern),
  ...
  (l || h & kn) &&
    ...
    n ||
      (e.strokeFirst ? (a && hd(r, e), o && fd(r, e)) : (o && fd(r, e), a && hd(r, e))),
    T && r.setLineDash([]);
}
function cM(r, t, e) {
  ...
  if ((i != null && (i += ""), i)) {
    ...
    r.setLineDash && e.lineDash && ((n = i0(t)), (a = n[0]), (o = n[1])),
      ...
      e.strokeFirst
        ...
        : (os(e) && r.fillText(i, e.x, e.y), as(e) && r.strokeText(i, e.x, e.y)),
      a && r.setLineDash([]);
  }
}
...
function a0(r, t, e, n, i) {
  ...
  (n || t.blend !== e.blend) &&
    (a || (Zt(r, i), (a = !0)), (r.globalCompositeOperation = t.blend || rn.blend));
  ...
  return (
    (n || t.shadowColor !== e.shadowColor) &&
      (a || (Zt(r, i), (a = !0)), (r.shadowColor = t.shadowColor || rn.shadowColor)),
    a
  );
}
function dd(r, t, e, n, i) {
  ...
  if (
    ...
    (n || a.opacity !== o.opacity) &&
      (s || (Zt(r, i), (s = !0)), (r.globalAlpha = a.opacity == null ? 1 : a.opacity)),
    t.hasStroke())
  ) {
    var u = a.lineWidth,
...
function xd(r, t) {
  ...
  function u(l) {
    ...
    var p = l0(o.dashArrayX),
      ...
      b = M(),
      T;
    w && ((w.width = b.width * e), (w.height = b.height * e), (T = w.getContext("2d"))),
      D(),
      h && _d.put(d, w || x),
      (l.image = w),
      (l.svgElement = x),
    ...
    function D() {
      T &&
        ...
        o.backgroundColor &&
          ((T.fillStyle = o.backgroundColor), T.fillRect(0, 0, w.width, w.height)));
      for (var A = 0, L = 0; L < y.length; ++L) A += y[L];
      if (A <= 0) return;
      for (var I = -S, P = 0, E = 0, R = 0; I < b.height; ) {
        if (P % 2 === 0) {
          for (var V = (E / 2) % m.length, F = 0, B = 0, $ = 0; F < b.width * 2; ) {
      ...
      function ze(It, St, X, tt, Tr) {
        var Bt = i ? 1 : e,
          Jh = br(Tr, It * Bt, St * Bt, X * Bt, tt * Bt, o.color, o.symbolKeepAspect);
        if (i) {
...
function u0(r) {
  ...
  if (t) return u0([r]);
  for (var n = [], e = 0; e < r.length; ++e) G(r[e]) ? n.push([r[e]]) : n.push(r[e]);
  return n;
}
function l0(r) {
      ...
      (t.prototype.getDataURL = function (e) {
        ...
        var s =
          this._zr.painter.getType() === "svg"
            ? this.getSvgDataURL()
            : this.renderToCanvas(e).toDataURL("image/" + ((e && e.type) || "png"));
        return (
          C(a, function (u) {
            u.group.ignore = !1;
          }),
                  ...
                  Wi(
                    ...
                    function (d) {
                      ...
                      if (g && g.dataIndex != null) {
                        ...
                        return (
                          (u = (p && p.getDataParams(g.dataIndex, g.dataType)) || {}),
                          !0
                        );
                      } else if (g.eventData) return (u = k({}, g.eventData)), !0;
                    },
                    !0,
                  ),
              u)
      ...
      (t.internalField = (function () {
        (Ln = function (h) {
          ...
          (Wu = function (h, c) {
            ...
            function S(x) {
              ...
              if (!M) {
                ...
                (M = new A()), M.init(v, m), (p[T] = M), g.push(M), y.add(M.group);
              }
              (x.__viewId = M.__id = T),
                (M.__alive = !0),
                (M.__model = x),
                    ...
                    if (!b)
                      if (sc(v))
                        if (x instanceof pa)
                          ...
                          var T = eh(x.mainType, x.componentIndex, v.name, h._api),
                            M = T.focusSelf,
                            D = T.dispatchers;
                          v.type === nn &&
                            M &&
                      ...
                      else Xl(v) && x instanceof pa && (ww(x, v, h._api), ic(x), te(h));
                  },
                  h,
                ),
              p &&
                p.eachComponent(
                  ...
                  function (x) {
                    ...
                    b ||
                      w(
                        h[d === "series" ? "_chartsMap" : "_componentsMap"][x.__viewId],
                      );
                  },
                  h,
                );
          ...
          (ir = {
            prepareAndUpdate: function (h) {
              Ln(this), ir.update.call(this, h, { optionChanged: h.newOption != null });
            },
            update: function (h, c) {
              var v = this._model,
                d = this._api,
            ...
            if (
              ...
              C(x, function (P) {
                if (
                  ...
                  D ? (uo(v, S, P, "series"), te(v)) : w && uo(v, S, P, w.main, w.sub);
              }),
              S !== "none" && !A && !D && !w)
            )
              try {
        ...
        function f(h, c) {
          var v = h.getModel("stateAnimation"),
            ...
            p =
              g > 0
                ? { duration: g, delay: v.get("delay"), easing: v.get("easing") }
                : null;
    ...
    return (
      ...
      (r.prototype.makeOutputDimensionNames = function () {
        for (var t = [], e = 0, n = 0; e < this._fullDimCount; e++) {
          var i = void 0,
            a = this.dimensions[n];
          if (a && a.storeDimIndex === e) a.isCalculationCoord || (i = a.name), n++;
          else {
  ...
  uD = (function () {
    ...
    return (
      ...
      (r.prototype._shouldMakeIdFromName = function () {
        ...
        return (
          this._idDimIdx == null && t.getSource().sourceFormat !== mr && !t.fillStorage
        );
      }),
      (r.prototype._doInit = function (t, e) {
        if (!(t >= e)) {
          ...
          if (u && !i.pure)
            for (var l = [], f = t; f < e; f++) {
              var h = i.getItem(f, l);
              if ((!this.hasItemOption && YS(h) && (this.hasItemOption = !0), h)) {
                var c = h.name;
          ...
          if (this._shouldMakeIdFromName()) for (var f = t; f < e; f++) Ku(this, f);
          Ed(this);
        }
      }),
      ...
      (r.prototype.getName = function (t) {
        var e = this.getRawIndex(t),
          n = this._nameList[e];
        return (
          n == null && this._nameDimIdx != null && (n = Di(this, this._nameDimIdx, e)),
          n == null && (n = ""),
          n
        );
      }),
      ...
      (r.prototype.downSample = function (t, e, n, i) {
        var a = ho(this);
        return (
          (a._store = this._store.downSample(this._getStoreDimIndex(t), e, n, i)), a
        );
      }),
      (r.prototype.lttbDownSample = function (t, e) {
        var n = ho(this);
      ...
      (r.prototype.cloneShallow = function (t) {
        return (
          t ||
            (t = new r(
              this._schema ? this._schema : ar(this.dimensions, this._getDimInfo, this),
              this.hostModel,
            )),
          qu(t, this),
  ...
  C(e, function (M) {
    ...
    if (G(M)) (D = M), (I = {});
      ...
      (I.ordinalMeta = null),
        ...
        (A = I.dimsDef),
        (L = I.otherDims),
        (I.name = I.coordDim = I.coordDimIndex = I.dimsDef = I.otherDims = null);
    }
    var E = h.get(D);
    if (E !== !1) {
      if (((E = _t(E)), !E.length))
    ...
    for (var x = 0; x < o; x++) {
      ...
      T == null &&
        ...
        b.type == null &&
          (wm(r, x) === qt.Must ||
            (b.isExtraCoord &&
              (b.otherDims.itemName != null || b.otherDims.seriesName != null))) &&
          (b.type = "ordinal");
    }
  return (
    hD(a),
    new D0({ source: r, dimensions: a, fullDimensionCount: o, dimensionOmitted: s })
  );
}
function hD(r) {
  for (var t = W(), e = 0; e < r.length; e++) {
...
function SD(r, t) {
  ...
  return (
    ...
    i ||
      (i = (n &&
        (n.getDimensionsInfo ? n.getDimensionsInfo() : n.dimensions.slice())) || [
        "x",
        "y",
      ]),
    i
...
function wD(r, t, e) {
  ...
  var n = t.getSourceManager(),
    i,
    a = !1;
  r ? ((a = !0), (i = xh(r))) : ((i = n.getSource()), (a = i.sourceFormat === de));
  var o = pD(t),
    s = SD(t, o),
    ...
    return (
      ...
      (t.prototype.getTicks = function (e) {
        ...
        for (
          var l = a[0];
          l <= a[1] &&
          (s.push({ value: l }), (l = $r(l + n, o)), l !== s[s.length - 1].value);

        )
          if (s.length > u) return [];
        var f = s.length ? s[s.length - 1].value : a[1];
        return (
          i[1] > f && (e ? s.push({ value: $r(f + n, o) }) : s.push({ value: i[1] })), s
        );
      }),
      (t.prototype.getMinorTicks = function (e) {
        for (
          ...
          for (
            var s = n[o], u = n[o - 1], l = 0, f = [], h = s.value - u.value, c = h / e;
            l < e - 1;
...
function kD(r) {
  ...
  C(r, function (n, i) {
    ...
    f &&
      !u[l].width &&
      ((u[l].width = f), (f = Math.min(s.remainedWidth, f)), (s.remainedWidth -= f));
    var h = n.barMaxWidth;
    h && (u[l].maxWidth = h);
    var c = n.barMinWidth;
    c && (u[l].minWidth = c);
  ...
  G0 = (function (r) {
    ...
    return (
      ...
      (t.prototype.calcNiceTicks = function (e, n, i) {
        ...
        (this._interval = vo[u][1]), (this._minLevelUnit = vo[Math.max(u - 1, 0)][0]);
      }),
      (t.prototype.parse = function (e) {
        return ft(e) ? e : +Xe(e);
      }),
...
function kd(r, t) {
  return (
    (r /= t ? ph : dh),
    r > 30 ? 30 : r > 20 ? 20 : r > 15 ? 15 : r > 10 ? 10 : r > 5 ? 5 : r > 2 ? 2 : 1
  );
}
function UD(r) {
  return qg(r, !0);
    ...
    if (!GD(qn(D), n[0], n[1], e)) {
      ...
      for (var E = 0; E < A.length - 1; E++) {
        ...
        if (R !== V) {
          ...
          switch (D) {
            case "year":
              (F = Math.max(1, Math.round(t / le / 365))), (B = gh(e)), ($ = $b(e));
              break;
            case "half-year":
            case "quarter":
            case "month":
    ...
    if (!!Wb(a[v])) {
      ...
      if (d !== g) {
        if (f.length) {
          ...
          var _ = (n[1] - n[0]) / t;
          if ((h > _ * 1.5 && c > _ / 1.5) || (l.push(p), h > _ || r === a[v])) break;
        }
        f = [];
      }
    }
...
function vA(r, t) {
  ...
  if (i) return i;
  var a, o;
  if (((!t.get("show") || r.scale.isBlank()) && (a = []), U(n))) a = Q0(r, n, !0);
  else if (n === "auto") {
...
function K0(r, t, e) {
  ...
  function g(p) {
    var y = { value: p };
    s.push(e ? p : { formattedLabel: n(y), rawLabel: i.getLabel(y), tickValue: p });
  }
  return s;
}
function Q0(r, t, e) {
  ...
  yA = (function () {
    ...
    return (
      ...
      (r.prototype.dataToCoord = function (t, e) {
        ...
        return (
          (t = i.normalize(t)),
          this.onBand && i.type === "ordinal" && ((n = n.slice()), Gd(n, i.count())),
          Et(t, zd, n, e)
        );
      }),
            ...
            function (s) {
              return {
                coord: this.dataToCoord(
                  this.scale.type === "ordinal" ? this.scale.getRawOrdinalNumber(s) : s,
                ),
                tickValue: s,
              };
            },
  ...
  for (
    ...
    switch (d) {
      case Zr.M:
        ...
        break;
      case Zr.L:
        (g = df(n, i, f[v], f[v + 1], h, c, Se, !0)), (n = f[v++]), (i = f[v++]);
        break;
      case Zr.C:
        (g = Rg(n, i, f[v++], f[v++], f[v++], f[v++], f[v], f[v + 1], h, c, Se)),
          (n = f[v++]),
          (i = f[v++]);
        break;
      case Zr.Q:
    ...
    if (!!(n && e)) {
      ...
      for (var v = 0; v < o.length; v++) {
        ...
        var g = r.getBoundingRect(),
          p = l ? l.distance(Mt) : r instanceof rt ? TA(Mt, r.path, Kt) : bA(Mt, g, Kt);
        p < u &&
          ((u = p),
          Mt.transform(f),
          Kt.transform(f),
  ...
  if (t <= 180 && t > 0) {
    ...
    if (!(e < 0.001 || n < 0.001)) {
      ...
      if (a < i) {
        ...
        var s =
          Kt.x !== Mt.x ? (Xr.x - Mt.x) / (Kt.x - Mt.x) : (Xr.y - Mt.y) / (Kt.y - Mt.y);
        if (isNaN(s)) return;
...
function DA(r, t, e) {
  ...
  for (var a = t.normal, o = a.get("show"), s = i.ignore, u = 0; u < Xo.length; u++) {
    var l = Xo[u],
      f = t[l],
      h = l === "normal";
    if (f) {
...
function t_(r, t, e, n, i, a) {
  ...
  function b(T) {
    ...
    for (var D = Math.ceil(T / (o - 1)), A = 0; A < o - 1; A++)
      if ((M > 0 ? w(D, 0, A + 1) : w(-D, o - A - 1, o), (T -= D), T <= 0)) return;
  }
  return l;
}
function LA(r, t, e, n) {
      ...
      (r.prototype.updateLayoutConfig = function (t) {
        ...
        for (var a = 0; a < this._labelList.length; a++) {
          var o = this._labelList[a],
            ...
            l = o.defaultAttr,
            f = void 0;
          U(o.layoutOption) ? (f = o.layoutOption(RA(o, u))) : (f = o.layoutOption),
            (f = f || {}),
...
var BA = (function (r) {
  ...
  return (
    ...
    (t.prototype.getLegendIcon = function (e) {
      var n = new bt(),
        i = br("line", 0, e.itemHeight / 2, e.itemWidth, 0, e.lineStyle.stroke, !1);
  ...
  return (
    ...
    (t.prototype._updateCommon = function (e, n, i, a, o) {
      ...
      if (s instanceof pn) {
        var T = s.style;
        s.useStyle(
          k({ image: T.image, x: T.x, y: T.y, width: T.width, height: T.height }, x),
        );
      } else
...
function YA(r, t, e, n, i, a, o, s) {
  ...
  for (
    var R = l.length, V = Vn(R), F = Vn(R), B = Vn(R), $ = Vn(R), it = [], _ = 0;
    _ < d.length;
    _++
  ) {
    var lt = d[_],
  ...
  return { current: V, next: F, stackedOnCurrent: B, stackedOnNext: $, status: it };
}
var or = Math.min,
  sr = Math.max;
function an(r, t) {
  ...
  for (var l, f, h, c, v, d, g = e, p = 0; p < n; p++) {
    ...
    if (g === e) r[a > 0 ? "moveTo" : "lineTo"](y, m), (h = y), (c = m);
      ...
      if (o > 0) {
        ...
        var T = p + 1;
        if (u)
          for (; an(x, b) && T < n; ) T++, (w += a), (x = t[w * 2]), (b = t[w * 2 + 1]);
        var M = 0.5,
          D = 0,
          A = 0,
          L = void 0,
  ...
  $A = (function (r) {
    ...
    return (
      ...
      (t.prototype.buildPath = function (e, n) {
        ...
        for (; a < o; )
          a += pf(e, i, a, o, o, 1, n.smooth, n.smoothMonotone, n.connectNulls) + 1;
      }),
      (t.prototype.getPointOn = function (e, n) {
        this.path || (this.createPathProxy(), this.buildPath(this.path, this.shape));
        for (
          var i = this.path, a = i.data, o = qe.CMD, s, u, l = n === "x", f = [], h = 0;
          h < a.length;
    ...
    if (!!a) {
      var u = t.getAxis(i),
        l = z(a.stops, function (_) {
          return { coord: u.toGlobalCoord(u.dataToCoord(_.value)), color: _.color };
        }),
        f = l.length,
  ...
  if (QA(t, "cartesian2d")) {
    var i = n.getModel("endLabel"),
      ...
      f = qA(
        ...
        function () {
          var v = r._endLabel;
          v && e && s.originalX != null && v.attr({ x: s.originalX, y: s.originalY });
        },
        u,
      );
    if (!n.get("clip", !0)) {
...
function o2(r, t) {
  ...
  return {
    normal: { align: r.get("align") || a, verticalAlign: r.get("verticalAlign") || o },
  };
}
var s2 = (function (r) {
  O(t, r);
  ...
  return (
    ...
    (t.prototype.render = function (e, n, i) {
      ...
      if (
        ...
        oc(g, e, "lineStyle"),
        g.style.lineWidth > 0 && e.get(["emphasis", "lineStyle", "width"]) === "bolder")
      ) {
      ...
      if ((g.setShape({ smooth: it, smoothMonotone: lt, connectNulls: T }), p)) {
      ...
      if (
        ...
        if (!l) {
          ...
          if (
            isNaN(f) ||
            isNaN(h) ||
            (this._clipShapeForSymbol && !this._clipShapeForSymbol.contain(f, h))
          )
            return;
          var c = e.get("zlevel"),
            v = e.get("z");
    ...
    (t.prototype._newPolyline = function (e) {
      ...
      return (
        ...
        (n = new $A({ shape: { points: e }, segmentIgnoreThreshold: 2, z2: 10 })),
      ...
      e.eachItemGraphicEl(function (v, d) {
        ...
        if (g) {
          ...
          if (i)
            if (o) {
              var S = i,
                w = n.pointToCoord(p);
              a
                ? ((y = S.startAngle), (m = S.endAngle), (_ = (-w[1] / 180) * Math.PI))
                : ((y = S.r0), (m = S.r), (_ = w[0]));
            } else {
              var x = i;
              a
          ...
          g.attr({ scaleX: 0, scaleY: 0 }),
            ...
            D && D.animateFrom({ style: { opacity: 0 } }, { duration: 300, delay: T }),
    ...
    (t.prototype._endLabelOnDuring = function (e, n, i, a, o, s, u) {
      ...
      if (l) {
        ...
        if (D >= 1) {
          if (D > 1 && !v) {
            var L = Qd(h, M[0]);
            l.attr({ x: L[0] + w, y: L[1] + x }), o && (A = c.getRawValue(M[0]));
          } else {
    ...
    (t.prototype._doUpdateAnimation = function (e, n, i, a, o, s, u) {
      ...
      if (
        ...
        l.stopAnimation(),
          l.setShape({ points: g }),
          f && (f.stopAnimation(), f.setShape({ points: g, stackedOnPoints: p }));
        return;
      }
      ...
      c.current !== v && (y.shape.__points = c.next),
        ...
        f &&
          ...
          l.shape.points !== f.shape.points && (f.shape.points = l.shape.points));
          ...
          u && {
            progress: function (v, d) {
              for (
                ...
                o ? ((p[S++] = w[0]), (p[S++] = w[1])) : d.setItemLayout(_, w.slice());
              }
    ...
    reset: function (t, e, n) {
      ...
      if (s > 10 && o.type === "cartesian2d" && a) {
        var u = o.getBaseAxis(),
          ...
          v = Math.round(s / c);
        if (isFinite(v) && v > 1) {
          a === "lttb" && t.setData(i.lttbDownSample(i.mapDimension(l.dim), 1 / v));
          var d = void 0;
          G(a) ? (d = f2[a]) : U(a) && (d = a),
      ...
      s = (function (u) {
        ...
        return (
          ...
          (l.prototype.optionUpdated = function () {
            var f = this.option;
            f.type === "category" && (this.__ordinalMeta = vf.createByAxisModel(this));
          }),
...
var w2 = (function (r) {
    ...
    return (
      ...
      (t.prototype.containData = function (e) {
        return (
          this.getAxis("x").containData(e[0]) && this.getAxis("y").containData(e[1])
        );
      }),
      ...
      (t.prototype.clampData = function (e, n) {
        ...
        return (
          (n = n || []),
          (n[0] = Math.min(Math.max(Math.min(o[0], o[1]), u), Math.max(o[0], o[1]))),
          (n[1] = Math.min(Math.max(Math.min(s[0], s[1]), l), Math.max(s[0], s[1]))),
          n
        );
      }),
...
function C2(r, t, e) {
  ...
  r.setExtent(l[0], l[1]), r.calcNiceExtent({ splitNumber: o, fixMin: f, fixMax: h });
...
var M2 = (function () {
  ...
  return (
    ...
    (r.prototype._findConvertTarget = function (t) {
      var e = t.seriesModel,
        n = t.xAxisModel || (e && e.getReferringComponents("xAxis", zt).models[0]),
        i = t.yAxisModel || (e && e.getReferringComponents("yAxis", zt).models[0]),
        a = t.gridModel,
        o = this._coordsList,
        s,
        u;
...
var dr = Math.PI,
  on = (function () {
    function r(t, e) {
      ...
      var n = new bt({ x: e.position[0], y: e.position[1], rotation: e.rotation });
  ...
  ap = {
    axisLine: function (r, t, e, n) {
      ...
      if (
        (i === "auto" && r.handleAutoShown && (i = r.handleAutoShown("axisLine")), !!i)
      ) {
    ...
    axisTickLabel: function (r, t, e, n) {
      var i = P2(e, n, t, r),
        a = E2(e, n, t, r);
      if (
        (I2(t, a, i), R2(e, n, t, r.tickDirection), t.get(["axisLabel", "hideOverlap"]))
      ) {
        var o = j0(
          z(a, function (s) {
      ...
      if (!!i) {
        ...
        sp(a)
          ...
          : ((c = L2(r.rotation, a, v || 0, l)),
            ...
            d != null &&
              ((d = Math.abs(d / Math.sin(c.rotation))), !isFinite(d) && (d = null)));
        var g = s.getFont(),
...
function I2(r, t, e) {
  if (!U0(r.axis)) {
    ...
    var a = t[0],
      ...
      h = e[e.length - 1],
      c = e[e.length - 2];
    n === !1 ? (re(a), re(l)) : op(a, o) && (n ? (re(o), re(f)) : (re(a), re(l))),
      i === !1 ? (re(s), re(h)) : op(u, s) && (i ? (re(u), re(c)) : (re(s), re(h)));
  }
}
function re(r) {
  r && (r.ignore = !0);
...
function u_(r, t, e, n, i) {
  for (var a = [], o = [], s = [], u = 0; u < r.length; u++) {
    var l = r[u].coord;
    (o[0] = l), (o[1] = 0), (s[0] = l), (s[1] = e), t && (fe(o, o, t), fe(s, s, t));
    var f = new fn({
      subPixelOptimize: !0,
    ...
    for (
      var s = a.getModel("lineStyle"),
        ...
        f = u_(
          ...
          t.transform,
          u,
          q(s.getLineStyle(), { stroke: e.get(["axisLine", "lineStyle", "color"]) }),
          "ticks",
        ),
        h = 0;
      h < f.length;
          ...
          T = new Dt({
            ...
            style: Qe(S, {
              ...
              verticalAlign:
                ...
                f.textVerticalAlign,
              fill: U(x)
                ? x(i.type === "category" ? _ : i.type === "value" ? y + "" : y, p)
                : x,
            }),
          });
...
const l_ = on;
function O2(r, t) {
  var e = { axesInfo: {}, seriesInvolved: !1, coordSysAxesInfo: {}, coordSysMap: {} };
...
function k2(r, t, e) {
  ...
  C(e.getCoordinateSystems(), function (s) {
    ...
    if ((C(s.getAxes(), ot(g, !1, null)), s.getTooltipAxes && n && h.get("show"))) {
    ...
    function g(p, y, m) {
      var _ = m.model.getModel("axisPointer", i),
        S = _.get("show");
      if (!(!S || (S === "auto" && !p && !_f(_)))) {
        y == null && (y = _.get("triggerTooltip")), (_ = p ? B2(m, h, i, t, p, y) : _);
        var w = _.get("snap"),
          x = xa(m.model),
    ...
    return (
      ...
      (t.prototype._doUpdateAxisPointerClass = function (e, n, i) {
        ...
        if (!!a) {
          var o = G2(e);
          o
            ? (this._axisPointer || (this._axisPointer = new a())).render(e, o, n, i)
    ...
    return (
      (t.prototype.render = function (e, n, i, a) {
        ...
        if (
          ...
          f || Jy(o, this._axisGroup, e), r.prototype.render.call(this, e, n, i, a);
        }
      }),
...
Fe({ type: "takeGlobalCursor", event: "globalCursorTaken", update: "update" }, Gt);
var J2 = (function (r) {
  O(t, r);
  function t(e) {
    var n = r.call(this) || this;
...
function Oa(r, t, e, n, i, a) {
  ...
  return (
    (h = ol(t, n)),
    i != null && (h.sign !== u.sign || h.span < i) && (t[1 - n] = t[n] + u.sign * i),
    (h = ol(t, n)),
  ...
  lL = (function (r) {
    ...
    return (
      ...
      (t.prototype.unmount = function () {
        return this.enableBrush(!1), xf(this), this._zr.remove(this.group), this;
      }),
      (t.prototype.dispose = function () {
...
function cn(r, t) {
  ...
  r.trigger("brush", { areas: e, isEnd: !!t.isEnd, removeOnClick: !!t.removeOnClick });
}
function fL(r) {
  var t = r._track;
  ...
  i.useStyle(Hh(e)),
    ...
    C(
      ...
      function (a) {
        ...
        o &&
          o.attr({ silent: !n, invisible: !n, cursor: n ? sL[s] + "-resize" : null });
      },
    );
}
...
function gp(r, t) {
  if (r._dragging) {
    ...
    var e = t.offsetX,
      ...
      a = T_(r, t, i, !0);
    (r._dragging = !1), (r._track = []), (r._creatingCover = null), a && cn(r, a);
  }
}
function yL(r, t, e) {
  var n = r._zr;
...
function yp(r) {
  return {
    ...
    updateCoverShape: function (t, e, n, i) {
      var a,
        o = m_(t, e);
      if (o !== vn && o.getLinearBrushOtherExtent) a = o.getLinearBrushOtherExtent(r);
      else {
        var s = t._zr;
  ...
  wL = (function () {
    ...
    return (
      ...
      (r.prototype.updateLabelEl = function (t, e, n, i) {
        var a = Jr(t).labelEl;
        a &&
          (a.setStyle(e.label.style), n(a, { x: e.label.x, y: e.label.y }), Sp(a, i));
      }),
      (r.prototype._renderHandle = function (t) {
        if (!(this._dragging || !this.updateHandleTransform)) {
          ...
          N(u) || (u = [u, u]),
            (i.scaleX = u[0] / 2),
            (i.scaleY = u[1] / 2),
            Hs(this, "_doDispatchAxisPointer", a.get("throttle") || 0, "fixRate"),
      ...
      (r.prototype._moveHandleToValue = function (t, e) {
        _p(
          ...
          this._handle,
          ul(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)),
        );
      }),
...
function CL(r, t, e, n, i) {
  ...
  g === "bottom" && (h[1] -= v), g === "middle" && (h[1] -= v / 2), ML(h, c, v, n);
...
function VL(r, t, e) {
  ...
  if (!!s) {
    Fo(i) && (i = L_({ seriesIndex: a.seriesIndex, dataIndex: a.dataIndex }, t).point);
    var u = Fo(i),
      l = a.axesInfo,
      f = s.axesInfo,
      h = n === "leave" || Fo(i),
    ...
    C(s.coordSysMap, function (y, m) {
      ...
      C(s.coordSysAxesInfo[m], function (S, w) {
        ...
        if (!h && _ && (!l || b)) {
          var T = b && b.value;
          T == null && !u && (T = x.pointToData(i)), T != null && Mp(S, T, g, !1, c);
        }
      });
    });
    var p = {};
    ...
    C(t.seriesModels, function (u, l) {
      ...
      if (!(h == null || !isFinite(h))) {
        var d = r - h,
          g = Math.abs(d);
        g <= o &&
          ((g < o || (d >= 0 && s < 0)) && ((o = g), (s = d), (i = h), (a.length = 0)),
          C(c, function (p) {
            a.push({
...
function XL(r, t, e) {
  ...
  C(a, function (l, f) {
    ...
    u.length &&
      e.dispatchAction({ type: "downplay", escapeConnect: !0, notBlur: !0, batch: u }),
    s.length &&
      e.dispatchAction({ type: "highlight", escapeConnect: !0, notBlur: !0, batch: s });
}
function qL(r, t) {
  for (var e = 0; e < (r || []).length; e++) {
    var n = r[e];
      ...
      (t.prototype._fillAutoTargetAxisByOrient = function (e, n) {
        ...
        function u(l, f) {
          ...
          if (!!h) {
            var c = new ll();
            if (
              (c.add(h.componentIndex), e.set(f, c), (a = !1), f === "x" || f === "y")
            ) {
    ...
    return (
      ...
      (r.prototype.calculateDataWindow = function (t) {
        ...
        Nn(["start", "end"], function (c, v) {
          ...
          a[v] === "percent"
            ...
            : ((l = !0), (g = g == null ? e[v] : i.parse(g)), (d = Et(g, e, o))),
            (u[v] = g),
            (s[v] = d);
        }),
          Ip(u),
      ...
      (r.prototype.reset = function (t) {
        if (t === this._dataZoomModel) {
          ...
          (this._dataExtent = oI(this, this._dimName, e)), this._updateMinMaxSpan();
    ...
    (t.prototype.render = function (e, n, i, a) {
      ...
      function c(d, g) {
        var p = h[d],
          ...
          S;
        if (
          (a && a.newTitle != null && a.featureName === p && (m.title = a.newTitle),
          p && !y)
        ) {
        ...
        (S.uid = Ia("toolbox-feature")), (S.model = _), (S.ecModel = n), (S.api = i);
          ...
          o.eachChild(function (d) {
            ...
            if (_ && !U(_) && g) {
              ...
              x + w.width / 2 > i.getWidth()
                ...
                : x - w.width / 2 < 0 && ((y.position = [0, M]), (S.align = "left"));
            }
          });
    }),
    ...
    (t.prototype.onclick = function (e, n) {
      ...
      if (U(MouseEvent) && (l.newEdge || (!l.ie && !l.edge))) {
        ...
        if (window.navigator.msSaveOrOpenBlob) {
          for (var p = d.length, y = new Uint8Array(p); p--; ) y[p] = d.charCodeAt(p);
          var m = new Blob([y]);
      ...
      (t.prototype.onclick = function (e, n, i) {
        ...
        if (!!Ep[i]) {
          ...
          C(SI, function (h) {
            ...
            e.eachComponent(
              { mainType: "series", query: o == null ? null : { seriesIndex: o } },
              u,
            );
          var l,
            f = i;
    ...
    r.eachRawSeries(function (i) {
      ...
      if (a && (a.type === "cartesian2d" || a.type === "polar")) {
        ...
        if (o.type === "category") {
          ...
          t[s] ||
            ((t[s] = { categoryAxis: o, valueAxis: a.getOtherAxis(o), series: [] }),
  ...
  return z(r, function (t) {
    ...
    return (
      e.each(e.dimensions, function () {
        for (
          var a = arguments.length, o = arguments[a - 1], s = e.getName(o), u = 0;
          u < a - 1;
          u++
        )
          i[u] = arguments[u];
...
function LI(r) {
  for (var t = r.split(/\n+/g), e = ls(t.shift()), n = [], i = 0; i < t.length; i++) {
    var a = ls(t[i]);
    if (!!a) {
      var o = a.split(Df),
        s = "",
...
function OI(r, t) {
  ...
  k_(t, function (n, i) {
    ...
    if (a < 0) {
      var s = r.queryComponents({ mainType: "dataZoom", subType: "select", id: i })[0];
      if (s) {
...
Fe({ type: "restore", event: "restore", update: "prepareAndUpdate" }, function (r, t) {
  ...
  HI = (function () {
    ...
    return (
          ...
          function (n) {
            ...
            if (((n.range = n.range || []), i && i !== !0)) {
              ...
              var a = fl[n.brushType](0, i.coordSys, n.coordRange),
                o = n.__rangeOffset;
              n.range = o
                ? Fp[n.brushType](a.values, o.offset, WI(a.xyMinMax, o.xyMinMax))
                : a.values;
            }
          },
          this,
      ...
      (r.prototype.findTargetInfo = function (t, e) {
        for (var n = this._targetInfoList, i = Op(e, t), a = 0; a < n.length; a++) {
          var o = n[a],
            s = t.panelId;
          if (s) {
      ...
      (!e && !n && !i) ||
        ...
        a.each(function (u) {
          ...
          C(l.getCartesians(), function (h, c) {
            (J(e, h.getAxis("x").model) >= 0 || J(n, h.getAxis("y").model) >= 0) &&
              f.push(h);
          }),
            t.push({
              panelId: "grid--" + u.id,
    ...
    return (
      ...
      (t.prototype._onBrush = function (e) {
        ...
        function s(l, f, h) {
          ...
          (g.minValueSpan != null || g.maxValueSpan != null) &&
            ...
            d && (i[d.id] = { dataZoomId: d.id, startValue: h[0], endValue: h[1] });
        }
        function u(l, f, h) {
          var c;
          return (
            h.eachComponent({ mainType: "dataZoom", subType: "select" }, function (v) {
      ...
      (t.prototype._dispatchZoomAction = function (e) {
        ...
        Lf(e, function (i, a) {
          ...
          n.length &&
            this.api.dispatchAction({ type: "dataZoom", from: this.uid, batch: n });
      }),
      (t.getDefaultOption = function (e) {
        var n = {
          show: !0,
...
function XI(r, t, e, n, i) {
  ...
  e._brushController
    ...
    .enableBrush(
      a && s.length
        ? { brushType: "auto", brushStyle: r.getModel("brushStyle").getItemStyle() }
        : !1,
    );
}
...
function rP(r) {
  return (
    (r =
      r === "left" ? "right" : r === "right" ? "left" : r === "top" ? "bottom" : "top"),
    r
  );
}
function nP(r, t, e) {
  ...
  J(["left", "right"], a) > -1
    ? ((s += "top:50%"),
      (u += "translateY(-50%) rotate(" + (l = a === "left" ? -225 : -45) + "deg)"))
    : ((s += "left:50%"),
      (u += "translateX(-50%) rotate(" + (l = a === "top" ? 225 : 45) + "deg)"));
  var f = (l * Math.PI) / 180,
    h = o + i,
    c = h * Math.abs(Math.cos(f)) + h * Math.abs(Math.sin(f)),
    v =
      Math.round(((c - Math.SQRT2 * i) / 2 + Math.SQRT2 * i - (c - h) / 2) * 100) / 100;
  s += ";" + a + ":-" + v + "px";
  var d = t + " solid " + i + "px;",
    g = [
...
var sP = (function () {
  ...
  return (
    ...
    (r.prototype.setContent = function (t, e, n, i, a) {
      ...
      var s = "";
      if ((G(a) && n.get("trigger") === "item" && !F_(n) && (s = nP(n, i, a)), G(t)))
        o.innerHTML = t + s;
      else if (t) {
        (o.innerHTML = ""), N(t) || (t = [t]);
    ...
    (r.prototype.moveTo = function (t, e) {
      ...
      if ((Vp(n, this._zr, this._appendToBody, t, e), n[0] != null && n[1] != null)) {
        var i = this.el.style,
          a = Hp(n[0], n[1]);
        C(a, function (o) {
          i[o[0]] = o[1];
...
function Wp(r) {
  ...
  return { left: fr(t - e), right: fr(t + e), top: fr(t - n), bottom: fr(t + n) };
}
function Up(r, t, e, n) {
      ...
      (t.prototype.init = function (e, n) {
        if (!(j.node || !n.getDom())) {
          ...
          this._tooltipContent =
            a === "richText"
              ? new fP(n)
              : new uP(n.getDom(), n, { appendToBody: i.get("appendToBody", !0) });
        }
      }),
      (t.prototype.render = function (e, n, i) {
        if (!(j.node || !i.getDom())) {
...
`
      ...
      (t.prototype._updatePosition = function (e, n, i, a, o, s, u) {
        ...
        if (
          ...
          U(n) &&
            (n = n([i, a], s, o.el, d, { viewSize: [l, f], contentSize: h.slice() })),
          N(n))
        )
...
function gP(r, t, e) {
  var n = Kf(r).queryOptionMap,
    i = n.keys()[0];
  if (!(!i || i === "series")) {
    var a = Da(t, i, n.get(i), { useDefault: !1, enableAll: !1, enableNone: !1 }),
      o = a.models[0];
    if (!!o) {
      ...
      if (
        ...
        return { componentMainType: i, componentIndex: o.componentIndex, el: u };
    }
  }
}
const yP = vP;
...
var mP = (function (r) {
    ...
    function t() {
      var e = (r !== null && r.apply(this, arguments)) || this;
      return (e.type = t.type), (e.layoutMode = { type: "box", ignoreSize: !0 }), e;
    }
    return (
      (t.type = "title"),
      (t.defaultOption = {
        ...
        if ((this.group.removeAll(), !!e.get("show"))) {
          ...
          (f.silent = !d && !p),
            ...
            (ut(f).eventData = ut(v).eventData =
              p ? { componentType: "title", componentIndex: e.componentIndex } : null),
            a.add(f),
            c && a.add(v);
          ...
          u ||
            ...
            u === "middle" && (u = "center"),
            u === "right" ? (_.x += _.width) : u === "center" && (_.x += _.width / 2)),
            l ||
  ...
  xP = (function (r) {
    ...
    return (
      ...
      (t.prototype._updateData = function (e) {
        ...
        var a = this.get("data") || n,
          o = z(
            ...
            function (s) {
              return (
                (G(s) || ft(s)) && (s = { name: s }), new At(s, this, this.ecModel)
              );
            },
            this,
          );
      ...
      (t.prototype.isSelected = function (e) {
        var n = this.option.selected;
        return !(n.hasOwnProperty(e) && !n[e]) && J(this._availableNames, e) >= 0;
      }),
      (t.prototype.getOrient = function () {
      ...
      (t.prototype.render = function (e, n, i) {
        ...
        if (((this._isFirstRender = !1), this.resetInner(), !!e.get("show", !0))) {
          var o = e.get("align"),
            s = e.get("orient");
          (!o || o === "auto") &&
            (o = e.get("left") === "right" && s === "vertical" ? "right" : "left");
          var u = e.get("selector", !0),
            l = e.get("selectorPosition", !0);
          u && (!l || l === "auto") && (l = s === "horizontal" ? "end" : "start"),
...
`)
                ...
                if (y) {
                  ...
                  i.eachRawSeries(function (b) {
                    if (!f.get(g) && b.legendVisualProvider) {
                      ...
                      L &&
                        L[3] === 0 &&
                        ((L[3] = 0.2), (D = k(k({}, D), { fill: ys(L, "rgba") })));
      ...
      (t.prototype._createItem = function (e, n, i, a, o, s, u, l, f, h) {
        ...
        var b = s === "left" ? v + 5 : -5,
          ...
          M = o.get("formatter"),
          D = n;
        G(M) && M ? (D = M.replace("{name}", n != null ? n : "")) : U(M) && (D = M(n));
        ...
        return (
          I.get("show") &&
            Ls({ el: L, componentModel: o, itemName: n, itemTooltipOption: I.option }),
          S.add(L),
...
function TP(r) {
  var t = r.icon || "roundRect",
    e = br(t, 0, 0, r.itemWidth, r.itemHeight, r.itemStyle.fill, r.symbolKeepAspect);
  return (
...
function Rf(r, t, e, n) {
  V_(e) ||
    e.dispatchAction({ type: "highlight", seriesName: r, name: t, excludeSeriesId: n });
}
function Ef(r, t, e, n) {
  V_(e) ||
    e.dispatchAction({ type: "downplay", seriesName: r, name: t, excludeSeriesId: n });
}
const W_ = wP;
function CP(r) {
  ...
  LP = (function (r) {
    ...
    return (
      ...
      (t.prototype._layoutContentAndController = function (e, n, i, a, o, s, u, l) {
        ...
        return (
          b.pageIndex != null &&
            we(f, { x: b.contentPosition[0], y: b.contentPosition[1] }, g ? e : null),
      ...
      (t.prototype._updatePageInfoView = function (e, n) {
        ...
        C(["pagePrev", "pageNext"], function (f) {
          ...
          v &&
            (v.setStyle(
              "fill",
              c ? e.get("pageIconColor", !0) : e.get("pageIconInactiveColor", !0),
            ),
...
function BP(r, t) {
  for (var e = qh(r).coordSysRecordMap, n = e.keys(), i = 0; i < n.length; i++) {
    var a = n[i],
      o = e.get(a),
      s = o.dataZoomInfoMap;
    if (s) {
      ...
      n.on(i, function (a) {
        ...
        e.dataZoomInfoMap.each(function (s) {
          if (!!a.isAvailableBehavior(s.model.option)) {
            var u = (s.getRange || {})[i],
              l = u && u(s.dzReferCoordSysInfo, e.model.mainType, e.controller, a);
...
function GP(r) {
  ...
  return (
    r.each(function (a) {
      ...
      n[e + s] > n[e + t] && (t = s), (i = i && o.get("preventDefaultMouseMove", !0));
    }),
    {
      controlType: t,
      opt: {
...
function Kp(r) {
  return function (t, e, n, i) {
    ...
    if (!!s) {
      var u = r(o, s, t, e, n, i);
      if ((Oa(u, o, [0, 100], "all"), (this.range = o), a[0] !== o[0] || a[1] !== o[1]))
        return o;
    }
  };
}
  ...
  JP = (function (r) {
    ...
    return (
      ...
      (t.prototype.render = function (e, n, i, a) {
        ...
        (!a || a.type !== "dataZoom" || a.from !== this.uid) && this._buildView(),
          this._updateView();
      }),
      (t.prototype.dispose = function () {
        this._clear(), r.prototype.dispose.apply(this, arguments);
              ...
              C(
                ...
                function (l) {
                  if (!i && !(n !== !0 && J(KP, l.get("type")) < 0)) {
                    ...
                    h != null && v.getOtherAxis && (c = v.getOtherAxis(f).inverse),
      ...
      (t.prototype._resetInterval = function () {
        ...
        this._handleEnds = [Et(e[0], [0, 100], n, !0), Et(e[1], [0, 100], n, !0)];
      }),
          ...
          if (((this._brushing = !1), !!n)) {
            ...
            if (!(a - this._brushStartTime < 200 && Math.abs(i.width) < 5)) {
              var o = this._getViewExtent(),
                s = [0, 100];
              (this._range = zi([Et(i.x, o, s, !0), Et(i.x + i.width, o, s, !0)])),
      ...
      (t.prototype._onBrush = function (e) {
        this._brushing && (Jn(e.event), this._updateBrushRect(e.offsetX, e.offsetY));
      }),
      (t.prototype._updateBrushRect = function (e, n) {
        ...
        o ||
          ((o = i.brushRect =
            new Oi({ silent: !0, style: a.getModel("brushStyle").getItemStyle() })),
          i.sliderGroup.add(o)),
          o.attr("ignore", !1);
...
var tg = {
  ...
  rR = (function () {
    ...
    return (
      (r.prototype.evaluate = function (t) {
        var e = typeof t;
        return G(e) ? this._condVal.test(t) : ft(e) ? this._condVal.test(t + "") : !1;
      }),
      r
    );
  })(),
...
function Kh(r, t) {
  ...
  return (
    $_(r) || et(n),
    r.and ? eg("and", r, t) : r.or ? eg("or", r, t) : r.not ? uR(r, t) : lR(r, t)
  );
}
function eg(r, t, e) {
  var n = t[r],
...
var vR = {
  ...
  cR = {
    ...
    transform: function (r) {
      ...
      o !== Vt && o !== Te && et(n);
      for (var s = [], u = 0, l = t.count(); u < l; u++) s.push(t.getRawDataItem(u));
      return (
        s.sort(function (f, h) {
          for (var c = 0; c < a.length; c++) {
            var v = a[c],
    ...
    switch (
      ...
      case Le.A:
        ...
        (c = Math.cos(b) * w + _),
          ...
          (a = Math.cos(T) * w + _),
          (o = Math.sin(T) * x + S);
        for (var D = ((M ? -1 : 1) * Math.PI) / 2, A = b; M ? A > T : A < T; A += D) {
...
function SR(r, t, e) {
  ...
  for (
    var c = [l.pt.x, l.pt.y], v = [f.pt.x, f.pt.y], d = [c], g = [v], a = l.idx + 1;
    a <= f.idx;
    a++
  )
    En(d, r[a].slice());
...
function TR(r, t) {
  ...
  switch (r.type) {
    ...
    case "circle":
      rg(
        { r0: 0, r: n.r, startAngle: 0, endAngle: Math.PI * 2, cx: n.cx, cy: n.cy },
        t,
        e,
      ),
        (i = ua);
    ...
    default:
      var a = r.getComputedTransform(),
        o = a
          ? Math.sqrt(Math.max(a[0] * a[0] + a[1] * a[1], a[2] * a[2] + a[3] * a[3]))
          : 1,
...
function DR(r, t, e, n) {
  for (
    var i = (r.length - 2) / 6, a = 1 / 0, o = 0, s = r.length, u = s - 2, l = 0;
    l < i;
    l++
  ) {
  ...
  for (var i = [], a, o = 0; o < r.length; o++) {
    ...
    if (((h[0] = s[y] - l[0]), (h[1] = s[y + 1] - l[1]), e > 0))
      for (var w = n / e, x = -n / 2; x <= n / 2; x += w) {
        for (var b = Math.sin(x), T = Math.cos(x), M = 0, _ = 0; _ < s.length; _ += 2) {
          var D = h[_],
            A = h[_ + 1],
            L = u[_] - f[0],
            I = u[_ + 1] - f[1],
      ...
      for (var B = 0; B < p; B += 2) (c[B] = u[B] - f[0]), (c[B + 1] = u[B + 1] - f[1]);
...
function IR(r, t, e, n, i, a) {
  ...
  for (var s = 0, u, l = (1 << o) / 2; l > 0; l /= 2) {
    ...
    (r & l) > 0 && (f = 1),
      ...
      (s += l * l * ((3 * f) ^ h)),
      h === 0 &&
        (f === 1 && ((r = l - 1 - r), (t = l - 1 - t)), (u = r), (r = t), (t = u));
  }
  return s;
}
function cs(r) {
...
function PR(r, t, e) {
  ...
  if (f)
    for (
      ...
      var S = f ? q({ delay: (e.delay || 0) + f(c, y, n[c], s[c]), done: _ }, e) : e;
      Qh(n[c], s[c], S);
    }
  else
    (t.__morphT = 0),
  ...
  return t.__zr && g(t.__zr), { fromIndividuals: n, toIndividuals: s, count: y };
}
function RR(r, t, e) {
  var n = t.length,
    i = [],
...
function lg(r, t) {
  for (var e = [], n = r.length, i = 0; i < n; i++) e.push({ one: r[i], many: [] });
...
var ER = {
  clone: function (r) {
    for (
      var t = [], e = 1 - Math.pow(1 - r.path.style.opacity, 1 / r.count), n = 0;
      n < r.count;
      n++
    ) {
      var i = rh(r.path);
...
function gl(r, t, e, n, i, a) {
  ...
  for (
    ...
    d += v[g].many.length;
  for (var p = 0, g = 0; g < v.length; g++) h(v[g], c, p, d), (p += v[g].many.length);
}
function Qr(r) {
  if (!r) return [];
  if (N(r)) {
  ...
  return (
    r.traverse(function (i) {
      i instanceof rt && !i.disableMorphing && !i.invisible && !i.ignore && n.push(i);
    }),
    n
  );
}
...
function J_(r, t, e) {
  ...
  function a(y, m, _, S, w) {
    (_ || y) &&
      m.animateFrom({ style: _ && _ !== y ? k(k({}, _.style), y.style) : y.style }, w);
  }
  function o(y) {
      ...
      if (a.isUniversalTransitionEnabled() && a.isAnimationEnabled()) {
        ...
        if (l)
          ...
          C(s, function (v) {
            ...
            f.length &&
              e.set(u, { oldSeries: f, newSeries: [{ data: o, divide: hr(o) }] });
        } else {
          var h = i.get(s);
          if (h) {
            var c = e.get(h.key);
...
function zR(r, t, e, n) {
  ...
  C(_t(r.from), function (o) {
    ...
    s >= 0 &&
      i.push({ data: t.oldData[s], divide: hr(t.oldData[s]), dim: o.dimension });
  }),
...
function nE(r) {
  r.registerUpdateLifecycle("series:beforeupdate", function (t, e, n) {
    ...
    r.registerUpdateLifecycle("series:transition", function (t, e, n) {
      ...
      for (
        var s = t.getSeries(), u = (i.oldSeries = []), l = (i.oldData = []), f = 0;
        f < s.length;
        f++
      ) {
        var h = s[f].getData();
  ...
  return (
      ...
      for (var h = this.__startIndex; h < this.__endIndex; ++h) {
        ...
        if (c) {
          var v = c.shouldBePainted(i, a, !0, !0),
            d = c.__isRendered && (c.__dirty & Qt || !v) ? c.getPrevPaintRect() : null;
          d && f(d);
          var g = v && (c.__dirty & Qt || !c.__isRendered) ? c.getPaintRect() : null;
          g && f(g);
        }
      }
    ...
    (t.prototype.resize = function (e, n) {
      ...
      o && ((o.width = e + "px"), (o.height = n + "px")),
        ...
        (a.height = n * i),
        s &&
          ((s.width = e * i), (s.height = n * i), i !== 1 && this.ctxBack.scale(i, i));
    }),
    (t.prototype.clear = function (e, n, i) {
      ...
      function d(g, p, y, m) {
        if ((o.clearRect(g, p, y, m), n && n !== "transparent")) {
          ...
          ps(n)
            ? ((_ =
                n.__canvasGradient || sf(o, n, { x: 0, y: 0, width: y, height: m })),
        ...
        l && (o.save(), (o.globalAlpha = f), o.drawImage(v, g, p, y, m), o.restore());
      }
      !i || l
        ? d(0, 0, s, u)
        : i.length &&
...
var UR = (function () {
  ...
  return (
    ...
    (r.prototype._paintHoverList = function (t) {
      ...
      if ((n && n.clear(), !!e)) {
        for (
          var i = { inHover: !0, viewWidth: this._width, viewHeight: this._height },
            a,
            o = 0;
          o < e;
          o++
    ...
    (r.prototype._doPaintEl = function (t, e, n, i, a, o) {
      ...
      if (n) {
        ...
        (!i || (u && u.intersect(i))) && (tn(s, t, a, o), t.setPrevPaintRect(u));
      } else tn(s, t, a, o);
    }),
    ...
    (r.prototype._updateLayerStatus = function (t) {
        ...
        s !== l && ((s = l), (o = 0)),
          i.incremental
            ? ((f = this.getLayer(l + HR, this._needsManuallyCompositing)),
              (f.incremental = !0),
              (o = 1))
            : (f = this.getLayer(l + (o > 0 ? So : 0), this._needsManuallyCompositing)),
          f.__builtin__ || Gf("ZLevel " + l + " has been used by unkown layer " + f.id),
          f !== a &&
            ((f.__used = !0),
      ...
      e(u),
        this.eachBuiltinLayer(function (h, c) {
          !h.__used &&
            h.getElementCount() > 0 &&
            ((h.__dirty = !0), (h.__startIndex = h.__endIndex = h.__drawIndex = 0)),
    ...
    (r.prototype.delLayer = function (t) {
      var e = this._layers,
        n = this._zlevelList,
        i = e[t];
      !i || (i.dom.parentNode.removeChild(i.dom), delete e[t], n.splice(J(n, t), 1));
    }),
