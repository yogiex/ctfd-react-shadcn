lint:
	...
	isort --profile=black --check-only --skip=CTFd/uploads --skip=CTFd/themes/admin/node_modules --skip=CTFd/themes/core/node_modules --skip=CTFd/themes/telkom-university/node_modules CTFd/ tests/
	cd CTFd/themes/admin && corepack yarn lint
	black --check --diff --exclude=CTFd/uploads --exclude=node_modules .
	prettier --check 'CTFd/themes/*/assets/**/*'
	prettier --check '**/*.md'

format:
	isort --profile=black --skip=CTFd/uploads --skip=CTFd/themes/admin/node_modules --skip=CTFd/themes/core/node_modules --skip=CTFd/themes/telkom-university/node_modules CTFd/ tests/
